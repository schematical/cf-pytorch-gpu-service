...
python /home/ubuntu/src/dreambooth/scripts/stable_txt2img.py --outdir "/home/ubuntu/src/outputs/$1" --ddim_eta 0.0 --n_samples 1 --n_iter 4 --scale 10.0 --ddim_steps 50 --seed $3 --ckpt $4 --prompt "$2"
